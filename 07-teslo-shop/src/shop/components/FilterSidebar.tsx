...
export const FilterSidebar = () => {
  ...
  const handleSizeFilterChanges = (size: string) => {
  ...
  const handlePriceFilterChanges = (price: string) => {
    setSearchParams((prev) => {
      prev.set("page", "1");
        ...
        <div className="grid grid-cols-3 gap-2">
          {sizes.map((size) => (
            <Button
              ...
              size="sm"
              className="h-8"
              onClick={() => handleSizeFilterChanges(size.id)}
            >
              {size.label}
            </Button>
          ))}
        ...
        >
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="any"
              id="priceAny"
              onClick={() => handlePriceFilterChanges("any")}
            />
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="0-50"
              id="price1"
              onClick={() => handlePriceFilterChanges("0-50")}
            />
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="50-100"
              id="price2"
              onClick={() => handlePriceFilterChanges("50-100")}
            />
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="100-200"
              id="price3"
              onClick={() => handlePriceFilterChanges("100-200")}
            />
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="200+"
              id="price4"
              onClick={() => handlePriceFilterChanges("200+")}
            />
